import { AssignedShift, DayTask, RoutineTemplate, ShiftTemplate, WasteEntry } from "../types";
...
// Standard-Müllplan (als WasteEntry-Array, ersetzt das alte hardcoded `waste`-Objekt)
export const initialWasteEntries: WasteEntry[] = [
  { id: "w1",  day: 3,  type: "GREEN" },
  { id: "w2",  day: 6,  type: "BIO"   },
  { id: "w3",  day: 10, type: "BLACK" },
  { id: "w4",  day: 14, type: "GLASS" },
  { id: "w5",  day: 17, type: "BIO"   },
  { id: "w6",  day: 22, type: "GREEN" },
  { id: "w7",  day: 26, type: "BLACK" },
];
...
export const initialRoutines: RoutineTemplate[] = [
  ...
  {
    id: "day-basic",
    name: "Tagdienst Routine",
    appliesTo: "day",
    steps: [
      { id: "day-1", title: "Aufstehen",    offsetMinutes: -90 },
      { id: "day-2", title: "Frühstück",   offsetMinutes: -65 },
      { id: "day-3", title: "Duschen",     offsetMinutes: -45 },
      { id: "day-4", title: "Losfahren",   offsetMinutes: -20 },
    ],
  },
];
